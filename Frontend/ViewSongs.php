...
background-size: cover;
    ...
    background-position: center;" ><!--End Menu-->
<div class="header_under"></div>
<!--Start Container for the web content-->
	<div class="playlist_wrapper" style="background-color:black;">
    
        	<div class="playlist_info"style="background-color:black;">
            	<table  cellspacing="0">
                <?php
                        ...
                        <td>
                        	<table>
                            	<tr>
                                	...
                                	<td style="color:white;"><?php echo $row['albumname']?></td>
                                </tr>
                                <tr>
                                	<td id="a1">Singer</td>
                                	<td id="a2" style="color:white;"><?php echo $row['albumsinger']?></td>
                                </tr>
                                <tr>
                                	<td id="a1">Writer</td>
                                	<td id="a2"style="color:white;"><?php echo $row['albumwriter']?></td>
                                </tr>
            ...
            <div class="playlist" style="background-color:black;">
...
<div class="footer_wrapper">
    <div class="footer_menu">
        ...
        <br /> <br /> <br />
        <span style="color:#999; font-size:14px; margin-top:10px;">&copy;2012 NTS Music, Inc.</span>
    </div>
</div>
</body>
</html>
